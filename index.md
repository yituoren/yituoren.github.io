...
I am interested in history, philosophy, literature and music so that I can think about the problems in the world from multiple perspectives. My long-term goal is to integrate high-level symbolic reasoning with low-level embodied perception, working toward generalist agents that can both reason about and physically interact with the open world.
...
> 🧭 **[Thinking About AGI Under Epistemic Humility →](/thinking/)**<br>
> A working framework on what constrains AI, where its real ceiling lies, and how my research fits in. A document I keep revising — if you think any part of it is wrong, I would like to hear from you.
